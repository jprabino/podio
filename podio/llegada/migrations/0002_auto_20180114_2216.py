...
from llegada.models import Race, Athlete, TimeRecord, Category
...
def athletes(apps, schema_editor):
    ...
    race_obj = Race.objects.get(pk=1)

    for ath in list_athletes:
        ath_obj = Athlete.objects.create(first_name = ath['first_name'],
        ...
        result_obj = TimeRecord.objects.create(athlete=ath_obj,
                                                 race=race_obj,
...
def init_race(apps, schema_editor):
    ...
    race_obj.available_categories.set(categories_obj)
